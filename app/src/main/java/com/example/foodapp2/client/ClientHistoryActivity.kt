...
class ClientHistoryActivity : AppCompatActivity() {
    ...
    private val clientHistoryViewModel by viewModels<ClientHistoryViewModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.clientHistoryViewModel= clientHistoryViewModel
        getData()
//        initListener()
        observeEvent()
...
//    }
    private fun observeEvent(){
        clientHistoryViewModel.isBack.observe(this){
